...
Para este proyecto se utilizó IA generativa como asistente. Las instrucciones evolucionaron desde pedir la estructura básica del documento hasta refinar el código de limpieza de datos e imputación de nulos. Cada bloque de código entregado fue verificado contrastando las funciones estadísticas utilizadas con la documentación oficial de R.